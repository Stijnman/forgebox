...
**Description**: Repository for forgebox - [Brief description to be added]
...
|-----------|-----------------|
| Bug Report | Open a [GitHub Issue](https://github.com/Stijnman/forgebox/issues) |
| Security Issue | Email: security@stijnman.com |
| General Question | Open a [GitHub Discussion](https://github.com/Stijnman/forgebox/discussions) |
